#!/usr/bin/env python3
# buildexaminer_v4.py — Washington Examiner builder (COPY MODE from buildsubstack_v4.py)
#
# Builder pattern identical to buildsubstack/dailysignal: fetch each article via
# canonical_url, run the LLM extractor with the source-keyed system prompt,
# parse canonical event blocks, write events JSON.
...
def _parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Democracy Clock V4 — Washington Examiner builder")
    ap.add_argument("--source", default=SOURCE_DEFAULT, help="Source key (default: examiner)")
